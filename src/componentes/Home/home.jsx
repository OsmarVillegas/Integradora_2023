...
export function NewsAndUpdates() {
  return(
    ...
    {noticias.map((noticias) => {
      const imagen = "../../imagenes/noticias/noticiasOptimen-" + noticias.img + ".jpg";
      console.log(noticias);
      console.log(imagen);
      return(
      <div className="newsAndUpdate-noticias col-2" style={{backgroundImage: `url("../../imagenes/noticias/noticiasOptimen-13.jpg")`}}>
        {/* <img src={require(`${imagen}`)} alt={noticias.titulo} className="newsAndUpdate-img"/> */}
